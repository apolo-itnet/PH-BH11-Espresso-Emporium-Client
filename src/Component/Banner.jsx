...
const Banner = () => {
  return (
    <div>
      ...
      <section>
        <div className="bg-orange-100 py-10">
          <div className="flex justify-center items-center flex-col">
            <h1 className="text-5xl font-bold font-calistoga">
              Our Delicious Offer
            </h1>
            <img
              ...
              className="py-6"
            />
            <p className="text-lg font-cabin tracking-wider">
      ...
      {/* section-3 */}
      <section className="bg-orange-100 py-10 px-10 flex md:flex-row flex-col justify-between items-center gap-10  ">
