...
const SignUp = () => {
    ...
    createUser(email, password)
      ...
      .catch((error) => {
        Swal.fire({
          position: "center",
          icon: "error",
          title: "Something went wrong, check your information",
          showConfirmButton: false,
          timer: 1500,
        });
        console.error(error);
  ...
  return (
    <div>
      {/* Hero */}
      <div className="relative bg-linear-to-bl from-blue-100 via-transparent my-6">
            ...
            <div>
              <form onSubmit={handleCreateUser}>
                <div className="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                  {/* Card */}
                  <div className="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg border border-gray-300/50">
                    ...
                    <div className="mt-5">
                      {/* google,facebook,instagram - button */}
                      <div className="flex flex-wrap items-center justify-center gap-3 ">
                        <div className="flex-1">
                          <button
                            type="button"
                            className="btn w-full py-5 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none group"
                          >
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <input
                              ...
                              className="peer p-3 sm:p-4 block w-full border border-gray-200 rounded-lg sm:text-sm placeholder:text-transparent focus:outline-none focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none
                              focus:pt-6
                              focus:pb-2
                        ...
                        <div className="relative col-span-full">
                          ...
                          <div className="relative">
                            <input
                              ...
                              name="password"
                              className="peer p-3 sm:p-4 block w-full border border-gray-200 rounded-lg sm:text-sm placeholder:text-transparent focus:outline-none focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none focus:pt-6 focus:pb-2 not-placeholder-shown:pt-6 not-placeholder-shown:pb-2 autofill:pt-6 autofill:pb-2"
                              placeholder="********"
                            />
                            <label
                              htmlFor="hs-hero-signup-form-floating-input-new-password" // htmlFor ম্যাচ করাও
                              className="absolute top-0 start-0 p-3 sm:p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent origin-[0_0] peer-disabled:opacity-50 peer-disabled:pointer-events-none peer-focus:scale-90 peer-focus:translate-x-0.5 peer-focus:-translate-y-1.5 peer-focus:text-gray-500 peer-not-placeholder-shown:scale-90 peer-not-placeholder-shown:translate-x-0.5 peer-not-placeholder-shown:-translate-y-1.5 peer-not-placeholder-shown:text-gray-500"
                            >
                              Password
                            </label>
                          </div>
                      ...
                      {/* Button */}
                      <div className="mt-5">
                        <button className="btn w-full p-3 items-center justify-center rounded-lg bg-orange-400 hover:bg-orange-500 transition-colors duration-200">
                          Sign Up
                        </button>
                      </div>
                      {/* End Button */}
